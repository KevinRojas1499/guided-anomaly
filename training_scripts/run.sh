...
SAMPLE_FLAGS="--batch_size $BATCH_SIZE --num_samples $NUM_SAMPLES --timestep_respacing ddim25 --use_ddim True --classifier_scale 1.0"
SCORE_CKPT="checkpoints/score_cond_best.pt"
UNCOND_SCORE_CKPT="checkpoints/score_uncond_best.pt"
...
mpiexec -n 1 python run_lib.py --mode comparison \
    ...
    --unconditional_model_path $UNCOND_SCORE_CKPT \
